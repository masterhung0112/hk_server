...
func (s *RetryLayer) TrackPoint() store.TrackPointStore {
	return s.TrackPointStore
}

func (s *RetryLayer) TrackRecord() store.TrackRecordStore {
...
type RetryLayerTrackPointStore struct {
	store.TrackPointStore
	Root *RetryLayer
}

type RetryLayerTrackRecordStore struct {
...
func (s *RetryLayerTrackPointStore) Get(trackPointId string) (*model.TrackPoint, error) {
...
func (s *RetryLayerTrackPointStore) GetByTargetId(targetId string) ([]*model.TrackPoint, error) {
...
func (s *RetryLayerTrackPointStore) Save(trackPoint *model.TrackPoint) (*model.TrackPoint, error) {
...
func (s *RetryLayerTrackRecordStore) End(trackRecordId string) (*model.TrackRecord, error) {
...
func (s *RetryLayerTrackRecordStore) Get(trackRecordId string) (*model.TrackRecord, error) {
...
func (s *RetryLayerTrackRecordStore) Save(trackRecord *model.TrackRecord) (*model.TrackRecord, error) {
...
func (s *RetryLayerTrackRecordStore) Start(trackRecordId string) (*model.TrackRecord, error) {
...
func (s *RetryLayerTrackRecordStore) Update(trackRecord *model.TrackRecord) (*model.TrackRecord, error) {
...
func New(childStore store.Store) *RetryLayer {
	...
	newStore.TrackPointStore = &RetryLayerTrackPointStore{TrackPointStore: childStore.TrackPoint(), Root: &newStore}
	newStore.TrackRecordStore = &RetryLayerTrackRecordStore{TrackRecordStore: childStore.TrackRecord(), Root: &newStore}
