...
// TrackPoint provides a mock function with given fields:
func (_m *Store) TrackPoint() store.TrackPointStore {
	ret := _m.Called()

	var r0 store.TrackPointStore
	if rf, ok := ret.Get(0).(func() store.TrackPointStore); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(store.TrackPointStore)
		}
	}
