...
func (s *TimerLayer) TrackPoint() store.TrackPointStore {
	return s.TrackPointStore
}

func (s *TimerLayer) TrackRecord() store.TrackRecordStore {
...
type TimerLayerTrackPointStore struct {
	store.TrackPointStore
	Root *TimerLayer
}

type TimerLayerTrackRecordStore struct {
...
func (s *TimerLayerTrackPointStore) Get(trackPointId string) (*model.TrackPoint, error) {
	start := timemodule.Now()
	...
	if s.Root.Metrics != nil {
		...
		s.Root.Metrics.ObserveStoreMethodDuration("TrackPointStore.Get", success, elapsed)
	}
	return result, err
}

func (s *TimerLayerTrackPointStore) GetByTargetId(targetId string) ([]*model.TrackPoint, error) {
	start := timemodule.Now()
	...
	if s.Root.Metrics != nil {
		...
		s.Root.Metrics.ObserveStoreMethodDuration("TrackPointStore.GetByTargetId", success, elapsed)
	}
	return result, err
}

func (s *TimerLayerTrackPointStore) Save(trackPoint *model.TrackPoint) (*model.TrackPoint, error) {
	start := timemodule.Now()
	...
	if s.Root.Metrics != nil {
		...
		s.Root.Metrics.ObserveStoreMethodDuration("TrackPointStore.Save", success, elapsed)
	}
	return result, err
}

func (s *TimerLayerTrackRecordStore) End(trackRecordId string) (*model.TrackRecord, error) {
	start := timemodule.Now()
	...
	if s.Root.Metrics != nil {
		...
		s.Root.Metrics.ObserveStoreMethodDuration("TrackRecordStore.End", success, elapsed)
	}
	return result, err
}

func (s *TimerLayerTrackRecordStore) Get(trackRecordId string) (*model.TrackRecord, error) {
	start := timemodule.Now()
	...
	if s.Root.Metrics != nil {
		...
		s.Root.Metrics.ObserveStoreMethodDuration("TrackRecordStore.Get", success, elapsed)
	}
	return result, err
}

func (s *TimerLayerTrackRecordStore) Save(trackRecord *model.TrackRecord) (*model.TrackRecord, error) {
	start := timemodule.Now()
	...
	if s.Root.Metrics != nil {
		...
		s.Root.Metrics.ObserveStoreMethodDuration("TrackRecordStore.Save", success, elapsed)
	}
	return result, err
}

func (s *TimerLayerTrackRecordStore) Start(trackRecordId string) (*model.TrackRecord, error) {
	start := timemodule.Now()
	...
	if s.Root.Metrics != nil {
		...
		s.Root.Metrics.ObserveStoreMethodDuration("TrackRecordStore.Start", success, elapsed)
	}
	return result, err
}

func (s *TimerLayerTrackRecordStore) Update(trackRecord *model.TrackRecord) (*model.TrackRecord, error) {
	start := timemodule.Now()
	...
	if s.Root.Metrics != nil {
		...
		s.Root.Metrics.ObserveStoreMethodDuration("TrackRecordStore.Update", success, elapsed)
	}
	return result, err
}
...
func New(childStore store.Store, metrics einterfaces.MetricsInterface) *TimerLayer {
	...
	newStore.TrackPointStore = &TimerLayerTrackPointStore{TrackPointStore: childStore.TrackPoint(), Root: &newStore}
	newStore.TrackRecordStore = &TimerLayerTrackRecordStore{TrackRecordStore: childStore.TrackRecord(), Root: &newStore}
