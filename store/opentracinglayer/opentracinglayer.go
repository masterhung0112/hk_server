...
type OpenTracingLayer struct {
	...
	TrackPointStore           store.TrackPointStore
	TrackRecordStore          store.TrackRecordStore
...
func (s *OpenTracingLayer) TrackPoint() store.TrackPointStore {
	return s.TrackPointStore
}

func (s *OpenTracingLayer) TrackRecord() store.TrackRecordStore {
	return s.TrackRecordStore
}
...
type OpenTracingLayerTrackPointStore struct {
	store.TrackPointStore
	Root *OpenTracingLayer
}

type OpenTracingLayerTrackRecordStore struct {
...
func (s *OpenTracingLayerTrackPointStore) Get(trackPointId string) (*model.TrackPoint, error) {
	origCtx := s.Root.Store.Context()
	span, newCtx := tracing.StartSpanWithParentByContext(s.Root.Store.Context(), "TrackPointStore.Get")
	s.Root.Store.SetContext(newCtx)
	defer func() {
		s.Root.Store.SetContext(origCtx)
	}()
	...
	defer span.Finish()
	result, err := s.TrackPointStore.Get(trackPointId)
	if err != nil {
		span.LogFields(spanlog.Error(err))
		ext.Error.Set(span, true)
	}
...
func (s *OpenTracingLayerTrackPointStore) GetByTargetId(targetId string) ([]*model.TrackPoint, error) {
	origCtx := s.Root.Store.Context()
	span, newCtx := tracing.StartSpanWithParentByContext(s.Root.Store.Context(), "TrackPointStore.GetByTargetId")
	s.Root.Store.SetContext(newCtx)
	defer func() {
		s.Root.Store.SetContext(origCtx)
	}()
	...
	defer span.Finish()
	result, err := s.TrackPointStore.GetByTargetId(targetId)
	if err != nil {
		span.LogFields(spanlog.Error(err))
		ext.Error.Set(span, true)
	}
...
func (s *OpenTracingLayerTrackPointStore) Save(trackPoint *model.TrackPoint) (*model.TrackPoint, error) {
	origCtx := s.Root.Store.Context()
	span, newCtx := tracing.StartSpanWithParentByContext(s.Root.Store.Context(), "TrackPointStore.Save")
	s.Root.Store.SetContext(newCtx)
	defer func() {
		s.Root.Store.SetContext(origCtx)
	}()
	...
	defer span.Finish()
	result, err := s.TrackPointStore.Save(trackPoint)
	if err != nil {
		span.LogFields(spanlog.Error(err))
		ext.Error.Set(span, true)
	}
...
func (s *OpenTracingLayerTrackRecordStore) End(trackRecordId string) (*model.TrackRecord, error) {
	origCtx := s.Root.Store.Context()
	span, newCtx := tracing.StartSpanWithParentByContext(s.Root.Store.Context(), "TrackRecordStore.End")
	s.Root.Store.SetContext(newCtx)
	defer func() {
		s.Root.Store.SetContext(origCtx)
	}()
	...
	defer span.Finish()
	result, err := s.TrackRecordStore.End(trackRecordId)
	if err != nil {
		span.LogFields(spanlog.Error(err))
		ext.Error.Set(span, true)
	}
...
func (s *OpenTracingLayerTrackRecordStore) Get(trackRecordId string) (*model.TrackRecord, error) {
	origCtx := s.Root.Store.Context()
	span, newCtx := tracing.StartSpanWithParentByContext(s.Root.Store.Context(), "TrackRecordStore.Get")
	s.Root.Store.SetContext(newCtx)
	defer func() {
		s.Root.Store.SetContext(origCtx)
	}()
	...
	defer span.Finish()
	result, err := s.TrackRecordStore.Get(trackRecordId)
	if err != nil {
		span.LogFields(spanlog.Error(err))
		ext.Error.Set(span, true)
	}
...
func (s *OpenTracingLayerTrackRecordStore) Save(trackRecord *model.TrackRecord) (*model.TrackRecord, error) {
	origCtx := s.Root.Store.Context()
	span, newCtx := tracing.StartSpanWithParentByContext(s.Root.Store.Context(), "TrackRecordStore.Save")
	s.Root.Store.SetContext(newCtx)
	defer func() {
		s.Root.Store.SetContext(origCtx)
	}()
	...
	defer span.Finish()
	result, err := s.TrackRecordStore.Save(trackRecord)
	if err != nil {
		span.LogFields(spanlog.Error(err))
		ext.Error.Set(span, true)
	}
...
func (s *OpenTracingLayerTrackRecordStore) Start(trackRecordId string) (*model.TrackRecord, error) {
	origCtx := s.Root.Store.Context()
	span, newCtx := tracing.StartSpanWithParentByContext(s.Root.Store.Context(), "TrackRecordStore.Start")
	s.Root.Store.SetContext(newCtx)
	defer func() {
		s.Root.Store.SetContext(origCtx)
	}()
	...
	defer span.Finish()
	result, err := s.TrackRecordStore.Start(trackRecordId)
	if err != nil {
		span.LogFields(spanlog.Error(err))
		ext.Error.Set(span, true)
	}
...
func (s *OpenTracingLayerTrackRecordStore) Update(trackRecord *model.TrackRecord) (*model.TrackRecord, error) {
	origCtx := s.Root.Store.Context()
	span, newCtx := tracing.StartSpanWithParentByContext(s.Root.Store.Context(), "TrackRecordStore.Update")
	s.Root.Store.SetContext(newCtx)
	defer func() {
		s.Root.Store.SetContext(origCtx)
	}()
	...
	defer span.Finish()
	result, err := s.TrackRecordStore.Update(trackRecord)
	if err != nil {
		span.LogFields(spanlog.Error(err))
		ext.Error.Set(span, true)
	}
...
func New(childStore store.Store, ctx context.Context) *OpenTracingLayer {
	...
	newStore.TrackPointStore = &OpenTracingLayerTrackPointStore{TrackPointStore: childStore.TrackPoint(), Root: &newStore}
	newStore.TrackRecordStore = &OpenTracingLayerTrackRecordStore{TrackRecordStore: childStore.TrackRecord(), Root: &newStore}
