...
Inline Image with link, alt text, and hover text: ![Build Status](https://travis-ci.org/mattermost/hk_server.svg?branch=master)](https://travis-ci.org/mattermost/hk_server)
