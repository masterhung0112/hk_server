...
func (ts *TelemetryService) trackConfig() {
	...
	ts.sendTelemetry(TrackConfigFile, map[string]interface{}{
		...
		"amazon_s3_ssl":           *cfg.FileSettings.S3SSL,
		"amazon_s3_sse":           *cfg.FileSettings.S3SSE,
		"amazon_s3_signv2":        *cfg.FileSettings.S3SignV2,
		"amazon_s3_trace":         *cfg.FileSettings.S3Trace,
