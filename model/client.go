...
func NewAPIv1SocketClient(socketPath string) *Client1 {
	tr := &http.Transport{
...
func (c *Client1) SetToken(token string) {
	c.AuthToken = token
	c.AuthType = HEADER_BEARER
}

// MockSession is deprecated in favour of SetToken
func (c *Client1) MockSession(token string) {
	c.SetToken(token)
}

func (c *Client1) SetOAuthToken(token string) {
	c.AuthToken = token
	c.AuthType = HEADER_TOKEN
}

func (c *Client1) ClearOAuthToken() {
	c.AuthToken = ""
	c.AuthType = HEADER_BEARER
}

func (c *Client1) GetUsersRoute() string {
	return "/users"
}
...
func (c *Client1) GetUserThreadsRoute(userID, teamID string) string {
	return c.GetUserRoute(userID) + c.GetTeamRoute(teamID) + "/threads"
}

func (c *Client1) GetUserThreadRoute(userId, teamId, threadId string) string {
	return c.GetUserThreadsRoute(userId, teamId) + "/" + threadId
}

func (c *Client1) GetUserCategoryRoute(userID, teamID string) string {
	return c.GetUserRoute(userID) + c.GetTeamRoute(teamID) + "/channels/categories"
}

func (c *Client1) GetUserAccessTokensRoute() string {
	return fmt.Sprintf(c.GetUsersRoute() + "/tokens")
}

func (c *Client1) GetUserAccessTokenRoute(tokenId string) string {
	return fmt.Sprintf(c.GetUsersRoute()+"/tokens/%v", tokenId)
}

func (c *Client1) GetUserByUsernameRoute(userName string) string {
	return fmt.Sprintf(c.GetUsersRoute()+"/username/%v", userName)
}

func (c *Client1) GetUserByEmailRoute(email string) string {
	return fmt.Sprintf(c.GetUsersRoute()+"/email/%v", email)
}

func (c *Client1) GetBotsRoute() string {
	return "/bots"
}

func (c *Client1) GetBotRoute(botUserId string) string {
...
func (c *Client1) GetTeamRoute(teamId string) string {
	return fmt.Sprintf(c.GetTeamsRoute()+"/%v", teamId)
}

func (c *Client1) GetTeamAutoCompleteCommandsRoute(teamId string) string {
	return fmt.Sprintf(c.GetTeamsRoute()+"/%v/commands/autocomplete", teamId)
}

func (c *Client1) GetTeamByNameRoute(teamName string) string {
	return fmt.Sprintf(c.GetTeamsRoute()+"/name/%v", teamName)
}

func (c *Client1) GetTeamMemberRoute(teamId, userId string) string {
	return fmt.Sprintf(c.GetTeamRoute(teamId)+"/members/%v", userId)
}

func (c *Client1) GetTeamMembersRoute(teamId string) string {
	return fmt.Sprintf(c.GetTeamRoute(teamId) + "/members")
}

func (c *Client1) GetTeamStatsRoute(teamId string) string {
	return fmt.Sprintf(c.GetTeamRoute(teamId) + "/stats")
}

func (c *Client1) GetTeamImportRoute(teamId string) string {
...
func (c *Client1) GetChannelsForTeamRoute(teamId string) string {
...
func (c *Client1) GetChannelByNameRoute(channelName, teamId string) string {
	return fmt.Sprintf(c.GetTeamRoute(teamId)+"/channels/name/%v", channelName)
}

func (c *Client1) GetChannelsForTeamForUserRoute(teamId, userId string, includeDeleted bool) string {
...
func (c *Client1) GetChannelByNameForTeamNameRoute(channelName, teamName string) string {
	return fmt.Sprintf(c.GetTeamByNameRoute(teamName)+"/channels/name/%v", channelName)
}

func (c *Client1) GetChannelMembersRoute(channelId string) string {
	return fmt.Sprintf(c.GetChannelRoute(channelId) + "/members")
}

func (c *Client1) GetChannelMemberRoute(channelId, userId string) string {
	return fmt.Sprintf(c.GetChannelMembersRoute(channelId)+"/%v", userId)
}

func (c *Client1) GetPostsRoute() string {
	return "/posts"
}

func (c *Client1) GetPostsEphemeralRoute() string {
...
func (c *Client1) GetLicenseRoute() string {
	return "/license"
}

func (c *Client1) GetPostRoute(postId string) string {
	return fmt.Sprintf(c.GetPostsRoute()+"/%v", postId)
}

func (c *Client1) GetFilesRoute() string {
	return "/files"
}

func (c *Client1) GetFileRoute(fileId string) string {
	return fmt.Sprintf(c.GetFilesRoute()+"/%v", fileId)
}

func (c *Client1) GetUploadsRoute() string {
	return "/uploads"
}

func (c *Client1) GetUploadRoute(uploadId string) string {
	return fmt.Sprintf("%s/%s", c.GetUploadsRoute(), uploadId)
}

func (c *Client1) GetPluginsRoute() string {
	return "/plugins"
}

func (c *Client1) GetPluginRoute(pluginId string) string {
	return fmt.Sprintf(c.GetPluginsRoute()+"/%v", pluginId)
}

func (c *Client1) GetSystemRoute() string {
	return "/system"
}

func (c *Client1) GetCloudRoute() string {
	return "/cloud"
}

func (c *Client1) GetTestEmailRoute() string {
	return "/email/test"
}

func (c *Client1) GetTestSiteURLRoute() string {
	return "/site_url/test"
}

func (c *Client1) GetTestS3Route() string {
	return "/file/s3_test"
}

func (c *Client1) GetDatabaseRoute() string {
	return "/database"
}

func (c *Client1) GetCacheRoute() string {
	return "/caches"
}

func (c *Client1) GetClusterRoute() string {
	return "/cluster"
}

func (c *Client1) GetIncomingWebhooksRoute() string {
	return "/hooks/incoming"
}

func (c *Client1) GetIncomingWebhookRoute(hookID string) string {
	return fmt.Sprintf(c.GetIncomingWebhooksRoute()+"/%v", hookID)
}

func (c *Client1) GetComplianceReportsRoute() string {
	return "/compliance/reports"
}

func (c *Client1) GetComplianceReportRoute(reportId string) string {
	return fmt.Sprintf("/compliance/reports/%v", reportId)
}

func (c *Client1) GetOutgoingWebhooksRoute() string {
	return "/hooks/outgoing"
}

func (c *Client1) GetOutgoingWebhookRoute(hookID string) string {
	return fmt.Sprintf(c.GetOutgoingWebhooksRoute()+"/%v", hookID)
}

func (c *Client1) GetPreferencesRoute(userId string) string {
	return fmt.Sprintf(c.GetUserRoute(userId) + "/preferences")
}

func (c *Client1) GetUserStatusRoute(userId string) string {
	return fmt.Sprintf(c.GetUserRoute(userId) + "/status")
}

func (c *Client1) GetUserStatusesRoute() string {
	return fmt.Sprintf(c.GetUsersRoute() + "/status")
}

func (c *Client1) GetSamlRoute() string {
	return "/saml"
}

func (c *Client1) GetLdapRoute() string {
	return "/ldap"
}

func (c *Client1) GetBrandRoute() string {
	return "/brand"
}

func (c *Client1) GetDataRetentionRoute() string {
	return "/data_retention"
}

func (c *Client1) GetElasticsearchRoute() string {
	return "/elasticsearch"
}

func (c *Client1) GetBleveRoute() string {
	return "/bleve"
}

func (c *Client1) GetCommandsRoute() string {
	return "/commands"
}

func (c *Client1) GetCommandRoute(commandId string) string {
	return fmt.Sprintf(c.GetCommandsRoute()+"/%v", commandId)
}

func (c *Client1) GetCommandMoveRoute(commandId string) string {
	return fmt.Sprintf(c.GetCommandsRoute()+"/%v/move", commandId)
}

func (c *Client1) GetEmojisRoute() string {
	return "/emoji"
}

func (c *Client1) GetEmojiRoute(emojiId string) string {
	return fmt.Sprintf(c.GetEmojisRoute()+"/%v", emojiId)
}

func (c *Client1) GetEmojiByNameRoute(name string) string {
	return fmt.Sprintf(c.GetEmojisRoute()+"/name/%v", name)
}

func (c *Client1) GetReactionsRoute() string {
	return "/reactions"
}

func (c *Client1) GetOAuthAppsRoute() string {
	return "/oauth/apps"
}

func (c *Client1) GetOAuthAppRoute(appId string) string {
	return fmt.Sprintf("/oauth/apps/%v", appId)
}

func (c *Client1) GetOpenGraphRoute() string {
	return "/opengraph"
}

func (c *Client1) GetJobsRoute() string {
	return "/jobs"
}

func (c *Client1) GetRolesRoute() string {
	return "/roles"
}

func (c *Client1) GetSchemesRoute() string {
	return "/schemes"
}

func (c *Client1) GetSchemeRoute(id string) string {
	return c.GetSchemesRoute() + fmt.Sprintf("/%v", id)
}

func (c *Client1) GetAnalyticsRoute() string {
	return "/analytics"
}

func (c *Client1) GetTimezonesRoute() string {
	return fmt.Sprintf(c.GetSystemRoute() + "/timezones")
}

func (c *Client1) GetChannelSchemeRoute(channelId string) string {
	return fmt.Sprintf(c.GetChannelsRoute()+"/%v/scheme", channelId)
}

func (c *Client1) GetTeamSchemeRoute(teamId string) string {
	return fmt.Sprintf(c.GetTeamsRoute()+"/%v/scheme", teamId)
}

func (c *Client1) GetTotalUsersStatsRoute() string {
	return fmt.Sprintf(c.GetUsersRoute() + "/stats")
}

func (c *Client1) GetRedirectLocationRoute() string {
	return "/redirect_location"
}

func (c *Client1) GetServerBusyRoute() string {
	return "/server_busy"
}

func (c *Client1) GetUserTermsOfServiceRoute(userId string) string {
	return c.GetUserRoute(userId) + "/terms_of_service"
}

func (c *Client1) GetTermsOfServiceRoute() string {
	return "/terms_of_service"
}

func (c *Client1) GetGroupsRoute() string {
	return "/groups"
}

func (c *Client1) GetPublishUserTypingRoute(userId string) string {
	return c.GetUserRoute(userId) + "/typing"
}

func (c *Client1) GetGroupRoute(groupID string) string {
	return fmt.Sprintf("%s/%s", c.GetGroupsRoute(), groupID)
}

func (c *Client1) GetGroupSyncableRoute(groupID, syncableID string, syncableType GroupSyncableType) string {
	return fmt.Sprintf("%s/%ss/%s", c.GetGroupRoute(groupID), strings.ToLower(syncableType.String()), syncableID)
}

func (c *Client1) GetGroupSyncablesRoute(groupID string, syncableType GroupSyncableType) string {
	return fmt.Sprintf("%s/%ss", c.GetGroupRoute(groupID), strings.ToLower(syncableType.String()))
}

func (c *Client1) GetImportsRoute() string {
	return "/imports"
}
...
func (c *Client1) DoApiPost(url string, data string) (*http.Response, *AppError) {
	return c.DoApiRequest(http.MethodPost, c.ApiUrl+url, data, "")
}

func (c *Client1) doApiPostBytes(url string, data []byte) (*http.Response, *AppError) {
	return c.doApiRequestBytes(http.MethodPost, c.ApiUrl+url, data, "")
}

func (c *Client1) DoApiPut(url string, data string) (*http.Response, *AppError) {
	return c.DoApiRequest(http.MethodPut, c.ApiUrl+url, data, "")
}

func (c *Client1) doApiPutBytes(url string, data []byte) (*http.Response, *AppError) {
...
func (c *Client1) DoApiRequest(method, url, data, etag string) (*http.Response, *AppError) {
	return c.doApiRequestReader(method, url, strings.NewReader(data), etag)
}

func (c *Client1) doApiRequestBytes(method, url string, data []byte, etag string) (*http.Response, *AppError) {
	return c.doApiRequestReader(method, url, bytes.NewReader(data), etag)
}

func (c *Client1) doApiRequestReader(method, url string, data io.Reader, etag string) (*http.Response, *AppError) {
...
func (c *Client1) DoUploadFile(url string, data []byte, contentType string) (*FileUploadResponse, *Response) {
	return c.doUploadFile(url, bytes.NewReader(data), contentType, 0)
}

func (c *Client1) doUploadFile(url string, body io.Reader, contentType string, contentLength int64) (*FileUploadResponse, *Response) {
...
func (c *Client1) DoEmojiUploadFile(url string, data []byte, contentType string) (*Emoji, *Response) {
...
func (c *Client1) DoUploadImportTeam(url string, data []byte, contentType string) (map[string]string, *Response) {
	rq, err := http.NewRequest("POST", c.ApiUrl+url, bytes.NewReader(data))
	if err != nil {
		return nil, &Response{Error: NewAppError(url, "model.client.connecting.app_error", nil, err.Error(), http.StatusBadRequest)}
	}
...
func (c *Client1) LoginById(id string, password string) (*User, *Response) {
...
func (c *Client1) LoginByLdap(loginId string, password string) (*User, *Response) {
	m := make(map[string]string)
	m["login_id"] = loginId
	m["password"] = password
...
// the session.
func (c *Client1) LoginWithDevice(loginId string, password string, deviceId string) (*User, *Response) {
	m := make(map[string]string)
	m["login_id"] = loginId
	m["password"] = password
...
func (c *Client1) LoginWithMFA(loginId, password, mfaToken string) (*User, *Response) {
	m := make(map[string]string)
	m["login_id"] = loginId
	m["password"] = password
	m["token"] = mfaToken
...
func (c *Client1) SwitchAccountType(switchRequest *SwitchRequest) (string, *Response) {
...
func (c *Client1) CreateUser(user *User) (*User, *Response) {
...
func (c *Client1) CreateUserWithToken(user *User, tokenId string) (*User, *Response) {
	if tokenId == "" {
...
func (c *Client1) CreateUserWithInviteId(user *User, inviteId string) (*User, *Response) {
	if inviteId == "" {
...
func (c *Client1) GetUser(userId, etag string) (*User, *Response) {
...
func (c *Client1) GetUserByUsername(userName, etag string) (*User, *Response) {
...
func (c *Client1) GetUserByEmail(email, etag string) (*User, *Response) {
...
func (c *Client1) AutocompleteUsersInTeam(teamId string, username string, limit int, etag string) (*UserAutocomplete, *Response) {
...
func (c *Client1) AutocompleteUsersInChannel(teamId string, channelId string, username string, limit int, etag string) (*UserAutocomplete, *Response) {
...
func (c *Client1) AutocompleteUsers(username string, limit int, etag string) (*UserAutocomplete, *Response) {
...
func (c *Client1) GetDefaultProfileImage(userId string) ([]byte, *Response) {
...
func (c *Client1) GetProfileImage(userId, etag string) ([]byte, *Response) {
...
func (c *Client1) GetUsersInTeam(teamId string, page int, perPage int, etag string) ([]*User, *Response) {
...
func (c *Client1) GetNewUsersInTeam(teamId string, page int, perPage int, etag string) ([]*User, *Response) {
...
func (c *Client1) GetRecentlyActiveUsersInTeam(teamId string, page int, perPage int, etag string) ([]*User, *Response) {
...
func (c *Client1) GetActiveUsersInTeam(teamId string, page int, perPage int, etag string) ([]*User, *Response) {
...
func (c *Client1) GetUsersNotInTeam(teamId string, page int, perPage int, etag string) ([]*User, *Response) {
...
func (c *Client1) GetUsersInChannel(channelId string, page int, perPage int, etag string) ([]*User, *Response) {
...
func (c *Client1) GetUsersInChannelByStatus(channelId string, page int, perPage int, etag string) ([]*User, *Response) {
...
func (c *Client1) GetUsersNotInChannel(teamId, channelId string, page int, perPage int, etag string) ([]*User, *Response) {
...
func (c *Client1) GetUsersWithoutTeam(page int, perPage int, etag string) ([]*User, *Response) {
...
func (c *Client1) GetUsersInGroup(groupID string, page int, perPage int, etag string) ([]*User, *Response) {
...
func (c *Client1) GetUsersByIds(userIds []string) ([]*User, *Response) {
...
// GetUsersByIds returns a list of users based on the provided user ids.
func (c *Client1) GetUsersByIdsWithOptions(userIds []string, options *UserGetByIdsOptions) ([]*User, *Response) {
	v := url.Values{}
	if options.Since != 0 {
...
func (c *Client1) GetUsersByUsernames(usernames []string) ([]*User, *Response) {
...
func (c *Client1) GetUsersByGroupChannelIds(groupChannelIds []string) (map[string][]*User, *Response) {
...
func (c *Client1) SearchUsers(search *UserSearch) ([]*User, *Response) {
...
func (c *Client1) UpdateUser(user *User) (*User, *Response) {
...
func (c *Client1) PatchUser(userId string, patch *UserPatch) (*User, *Response) {
...
func (c *Client1) UpdateUserAuth(userId string, userAuth *UserAuth) (*UserAuth, *Response) {
...
func (c *Client1) UpdateUserMfa(userId, code string, activate bool) (bool, *Response) {
...
func (c *Client1) CheckUserMfa(loginId string) (bool, *Response) {
	requestBody := make(map[string]interface{})
...
func (c *Client1) GenerateMfaSecret(userId string) (*MfaSecret, *Response) {
...
func (c *Client1) UpdateUserPassword(userId, currentPassword, newPassword string) (bool, *Response) {
...
func (c *Client1) UpdateUserHashedPassword(userId, newHashedPassword string) (bool, *Response) {
...
func (c *Client1) PromoteGuestToUser(guestId string) (bool, *Response) {
...
func (c *Client1) DemoteUserToGuest(guestId string) (bool, *Response) {
...
func (c *Client1) UpdateUserRoles(userId, roles string) (bool, *Response) {
...
func (c *Client1) UpdateUserActive(userId string, active bool) (bool, *Response) {
	requestBody := make(map[string]interface{})
...
func (c *Client1) DeleteUser(userId string) (bool, *Response) {
...
func (c *Client1) PermanentDeleteUser(userId string) (bool, *Response) {
...
func (c *Client1) ConvertUserToBot(userId string) (*Bot, *Response) {
...
func (c *Client1) ConvertBotToUser(userId string, userPatch *UserPatch, setSystemAdmin bool) (*User, *Response) {
	var query string
	if setSystemAdmin {
...
func (c *Client1) PermanentDeleteAllUsers() (bool, *Response) {
...
// provided email.
func (c *Client1) SendPasswordResetEmail(email string) (bool, *Response) {
...
func (c *Client1) ResetPassword(token, newPassword string) (bool, *Response) {
...
func (c *Client1) GetSessions(userId, etag string) ([]*Session, *Response) {
...
func (c *Client1) RevokeSession(userId, sessionId string) (bool, *Response) {
...
func (c *Client1) RevokeAllSessions(userId string) (bool, *Response) {
...
func (c *Client1) RevokeSessionsFromAllUsers() (bool, *Response) {
...
func (c *Client1) AttachDeviceId(deviceId string) (bool, *Response) {
...
func (c *Client1) GetTeamsUnreadForUser(userId, teamIdToExclude string) ([]*TeamUnread, *Response) {
	var optional string
	if teamIdToExclude != "" {
...
func (c *Client1) GetUserAudits(userId string, page int, perPage int, etag string) (Audits, *Response) {
	query := fmt.Sprintf("?page=%v&per_page=%v", page, perPage)
...
func (c *Client1) VerifyUserEmail(token string) (bool, *Response) {
...
func (c *Client1) VerifyUserEmailWithoutToken(userId string) (*User, *Response) {
...
// email address.
func (c *Client1) SendVerificationEmail(email string) (bool, *Response) {
	requestBody := map[string]string{"email": email}
...
func (c *Client1) SetDefaultProfileImage(userId string) (bool, *Response) {
...
func (c *Client1) SetProfileImage(userId string, data []byte) (bool, *Response) {
	body := &bytes.Buffer{}
...
func (c *Client1) CreateUserAccessToken(userId, description string) (*UserAccessToken, *Response) {
...
func (c *Client1) GetUserAccessTokens(page int, perPage int) ([]*UserAccessToken, *Response) {
	query := fmt.Sprintf("?page=%v&per_page=%v", page, perPage)
...
func (c *Client1) GetUserAccessToken(tokenId string) (*UserAccessToken, *Response) {
...
func (c *Client1) GetUserAccessTokensForUser(userId string, page, perPage int) ([]*UserAccessToken, *Response) {
	query := fmt.Sprintf("?page=%v&per_page=%v", page, perPage)
...
// 'edit_other_users' permission.
func (c *Client1) RevokeUserAccessToken(tokenId string) (bool, *Response) {
...
func (c *Client1) SearchUserAccessTokens(search *UserAccessTokenSearch) ([]*UserAccessToken, *Response) {
...
// 'edit_other_users' permission.
func (c *Client1) DisableUserAccessToken(tokenId string) (bool, *Response) {
	requestBody := map[string]string{"token_id": tokenId}
...
// 'edit_other_users' permission.
func (c *Client1) EnableUserAccessToken(tokenId string) (bool, *Response) {
	requestBody := map[string]string{"token_id": tokenId}
...
func (c *Client1) CreateBot(bot *Bot) (*Bot, *Response) {
...
func (c *Client1) PatchBot(userId string, patch *BotPatch) (*Bot, *Response) {
...
func (c *Client1) GetBot(userId string, etag string) (*Bot, *Response) {
...
func (c *Client1) GetBotIncludeDeleted(userId string, etag string) (*Bot, *Response) {
...
func (c *Client1) GetBots(page, perPage int, etag string) ([]*Bot, *Response) {
	query := fmt.Sprintf("?page=%v&per_page=%v", page, perPage)
...
func (c *Client1) GetBotsIncludeDeleted(page, perPage int, etag string) ([]*Bot, *Response) {
...
func (c *Client1) GetBotsOrphaned(page, perPage int, etag string) ([]*Bot, *Response) {
...
func (c *Client1) DisableBot(botUserId string) (*Bot, *Response) {
...
func (c *Client1) EnableBot(botUserId string) (*Bot, *Response) {
...
func (c *Client1) AssignBot(botUserId, newOwnerId string) (*Bot, *Response) {
...
func (c *Client1) SetBotIconImage(botUserId string, data []byte) (bool, *Response) {
	body := &bytes.Buffer{}
	writer := multipart.NewWriter(body)
...
func (c *Client1) GetBotIconImage(botUserId string) ([]byte, *Response) {
...
func (c *Client1) DeleteBotIconImage(botUserId string) (bool, *Response) {
...
func (c *Client1) GetTeam(teamId, etag string) (*Team, *Response) {
...
func (c *Client1) GetAllTeams(etag string, page int, perPage int) ([]*Team, *Response) {
	query := fmt.Sprintf("?page=%v&per_page=%v", page, perPage)
...
func (c *Client1) GetAllTeamsWithTotalCount(etag string, page int, perPage int) ([]*Team, int64, *Response) {
...
func (c *Client1) GetTeamByName(name, etag string) (*Team, *Response) {
...
func (c *Client1) SearchTeams(search *TeamSearch) ([]*Team, *Response) {
...
func (c *Client1) SearchTeamsPaged(search *TeamSearch) ([]*Team, int64, *Response) {
	if search.Page == nil {
...
func (c *Client1) TeamExists(name, etag string) (bool, *Response) {
...
func (c *Client1) GetTeamsForUser(userId, etag string) ([]*Team, *Response) {
...
func (c *Client1) GetTeamMember(teamId, userId, etag string) (*TeamMember, *Response) {
...
func (c *Client1) UpdateTeamMemberRoles(teamId, userId, newRoles string) (bool, *Response) {
...
func (c *Client1) UpdateTeamMemberSchemeRoles(teamId string, userId string, schemeRoles *SchemeRoles) (bool, *Response) {
...
func (c *Client1) UpdateTeam(team *Team) (*Team, *Response) {
...
func (c *Client1) PatchTeam(teamId string, patch *TeamPatch) (*Team, *Response) {
...
func (c *Client1) RestoreTeam(teamId string) (*Team, *Response) {
...
func (c *Client1) RegenerateTeamInviteId(teamId string) (*Team, *Response) {
...
func (c *Client1) SoftDeleteTeam(teamId string) (bool, *Response) {
...
func (c *Client1) PermanentDeleteTeam(teamId string) (bool, *Response) {
...
func (c *Client1) UpdateTeamPrivacy(teamId string, privacy string) (*Team, *Response) {
...
func (c *Client1) GetTeamMembers(teamId string, page int, perPage int, etag string) ([]*TeamMember, *Response) {
	query := fmt.Sprintf("?page=%v&per_page=%v", page, perPage)
...
func (c *Client1) GetTeamMembersSortAndWithoutDeletedUsers(teamId string, page int, perPage int, sort string, exclude_deleted_users bool, etag string) ([]*TeamMember, *Response) {
...
func (c *Client1) GetTeamMembersForUser(userId string, etag string) ([]*TeamMember, *Response) {
...
func (c *Client1) GetTeamMembersByIds(teamId string, userIds []string) ([]*TeamMember, *Response) {
...
func (c *Client1) AddTeamMember(teamId, userId string) (*TeamMember, *Response) {
...
func (c *Client1) AddTeamMemberFromInvite(token, inviteId string) (*TeamMember, *Response) {
	var query string
...
func (c *Client1) AddTeamMembers(teamId string, userIds []string) ([]*TeamMember, *Response) {
...
// AddTeamMembers adds a number of users to a team and returns the team members.
func (c *Client1) AddTeamMembersGracefully(teamId string, userIds []string) ([]*TeamMemberWithError, *Response) {
	var members []*TeamMember
	for _, userId := range userIds {
		member := &TeamMember{TeamId: teamId, UserId: userId}
		members = append(members, member)
...
func (c *Client1) RemoveTeamMember(teamId, userId string) (bool, *Response) {
...
func (c *Client1) GetTeamStats(teamId, etag string) (*TeamStats, *Response) {
...
// Must be authenticated.
func (c *Client1) GetTotalUsersStats(etag string) (*UsersStats, *Response) {
...
// Must be authenticated.
func (c *Client1) GetTeamUnread(teamId, userId string) (*TeamUnread, *Response) {
...
func (c *Client1) ImportTeam(data []byte, filesize int, importFrom, filename, teamId string) (map[string]string, *Response) {
	body := &bytes.Buffer{}
	writer := multipart.NewWriter(body)
...
func (c *Client1) InviteUsersToTeam(teamId string, userEmails []string) (bool, *Response) {
...
func (c *Client1) InviteGuestsToTeam(teamId string, userEmails []string, channels []string, message string) (bool, *Response) {
...
// InviteUsersToTeam invite users by email to the team.
func (c *Client1) InviteUsersToTeamGracefully(teamId string, userEmails []string) ([]*EmailInviteWithError, *Response) {
...
// InviteGuestsToTeam invite guest by email to some channels in a team.
func (c *Client1) InviteGuestsToTeamGracefully(teamId string, userEmails []string, channels []string, message string) ([]*EmailInviteWithError, *Response) {
	guestsInvite := GuestsInvite{
		Emails:   userEmails,
		Channels: channels,
		Message:  message,
...
func (c *Client1) InvalidateEmailInvites() (bool, *Response) {
...
func (c *Client1) GetTeamInviteInfo(inviteId string) (*Team, *Response) {
...
func (c *Client1) SetTeamIcon(teamId string, data []byte) (bool, *Response) {
	body := &bytes.Buffer{}
	writer := multipart.NewWriter(body)
...
func (c *Client1) GetTeamIcon(teamId, etag string) ([]byte, *Response) {
...
func (c *Client1) RemoveTeamIcon(teamId string) (bool, *Response) {
...
func (c *Client1) GetAllChannels(page int, perPage int, etag string) (*ChannelListWithTeamData, *Response) {
...
func (c *Client1) GetAllChannelsIncludeDeleted(page int, perPage int, etag string) (*ChannelListWithTeamData, *Response) {
	return c.getAllChannels(page, perPage, etag, true)
}

func (c *Client1) getAllChannels(page int, perPage int, etag string, includeDeleted bool) (*ChannelListWithTeamData, *Response) {
...
func (c *Client1) GetAllChannelsWithCount(page int, perPage int, etag string) (*ChannelListWithTeamData, int64, *Response) {
	query := fmt.Sprintf("?page=%v&per_page=%v&include_total_count="+c.boolString(true), page, perPage)
	r, err := c.DoApiGet(c.GetChannelsRoute()+query, etag)
	if err != nil {
		return nil, 0, BuildErrorResponse(r, err)
...
func (c *Client1) UpdateChannel(channel *Channel) (*Channel, *Response) {
...
func (c *Client1) PatchChannel(channelId string, patch *ChannelPatch) (*Channel, *Response) {
...
func (c *Client1) ConvertChannelToPrivate(channelId string) (*Channel, *Response) {
...
func (c *Client1) UpdateChannelPrivacy(channelId string, privacy string) (*Channel, *Response) {
	requestBody := map[string]string{"privacy": privacy}
...
func (c *Client1) RestoreChannel(channelId string) (*Channel, *Response) {
...
// ids provided.
func (c *Client1) CreateDirectChannel(userId1, userId2 string) (*Channel, *Response) {
...
func (c *Client1) CreateGroupChannel(userIds []string) (*Channel, *Response) {
...
func (c *Client1) GetChannel(channelId, etag string) (*Channel, *Response) {
...
func (c *Client1) GetChannelStats(channelId string, etag string) (*ChannelStats, *Response) {
...
func (c *Client1) GetChannelMembersTimezones(channelId string) ([]string, *Response) {
...
func (c *Client1) GetPinnedPosts(channelId string, etag string) (*PostList, *Response) {
...
func (c *Client1) GetPrivateChannelsForTeam(teamId string, page int, perPage int, etag string) ([]*Channel, *Response) {
...
func (c *Client1) GetPublicChannelsForTeam(teamId string, page int, perPage int, etag string) ([]*Channel, *Response) {
	query := fmt.Sprintf("?page=%v&per_page=%v", page, perPage)
	r, err := c.DoApiGet(c.GetChannelsForTeamRoute(teamId)+query, etag)
	if err != nil {
		return nil, BuildErrorResponse(r, err)
...
func (c *Client1) GetDeletedChannelsForTeam(teamId string, page int, perPage int, etag string) ([]*Channel, *Response) {
...
func (c *Client1) GetPublicChannelsByIdsForTeam(teamId string, channelIds []string) ([]*Channel, *Response) {
...
func (c *Client1) GetChannelsForTeamForUser(teamId, userId string, includeDeleted bool, etag string) ([]*Channel, *Response) {
...
func (c *Client1) GetChannelsForTeamAndUserWithLastDeleteAt(teamId, userId string, includeDeleted bool, lastDeleteAt int, etag string) ([]*Channel, *Response) {
	route := fmt.Sprintf(c.GetUserRoute(userId) + c.GetTeamRoute(teamId) + "/channels")
...
func (c *Client1) SearchChannels(teamId string, search *ChannelSearch) ([]*Channel, *Response) {
...
func (c *Client1) SearchArchivedChannels(teamId string, search *ChannelSearch) ([]*Channel, *Response) {
...
func (c *Client1) SearchAllChannels(search *ChannelSearch) (*ChannelListWithTeamData, *Response) {
...
func (c *Client1) SearchAllChannelsPaged(search *ChannelSearch) (*ChannelsWithCount, *Response) {
	r, err := c.DoApiPost(c.GetChannelsRoute()+"/search", search.ToJson())
	if err != nil {
		return nil, BuildErrorResponse(r, err)
	}
...
func (c *Client1) SearchGroupChannels(search *ChannelSearch) ([]*Channel, *Response) {
...
func (c *Client1) PermanentDeleteChannel(channelId string) (bool, *Response) {
...
func (c *Client1) MoveChannel(channelId, teamId string, force bool) (*Channel, *Response) {
...
func (c *Client1) GetChannelByName(channelName, teamId string, etag string) (*Channel, *Response) {
...
func (c *Client1) GetChannelByNameIncludeDeleted(channelName, teamId string, etag string) (*Channel, *Response) {
...
func (c *Client1) GetChannelByNameForTeamName(channelName, teamName string, etag string) (*Channel, *Response) {
...
func (c *Client1) GetChannelByNameForTeamNameIncludeDeleted(channelName, teamName string, etag string) (*Channel, *Response) {
...
func (c *Client1) GetChannelMembers(channelId string, page, perPage int, etag string) (*ChannelMembers, *Response) {
	query := fmt.Sprintf("?page=%v&per_page=%v", page, perPage)
...
func (c *Client1) GetChannelMembersByIds(channelId string, userIds []string) (*ChannelMembers, *Response) {
...
func (c *Client1) GetChannelMember(channelId, userId, etag string) (*ChannelMember, *Response) {
...
func (c *Client1) GetChannelMembersForUser(userId, teamId, etag string) (*ChannelMembers, *Response) {
...
func (c *Client1) ViewChannel(userId string, view *ChannelView) (*ChannelViewResponse, *Response) {
...
func (c *Client1) GetChannelUnread(channelId, userId string) (*ChannelUnread, *Response) {
...
func (c *Client1) UpdateChannelRoles(channelId, userId, roles string) (bool, *Response) {
	requestBody := map[string]string{"roles": roles}
...
func (c *Client1) UpdateChannelMemberSchemeRoles(channelId string, userId string, schemeRoles *SchemeRoles) (bool, *Response) {
...
func (c *Client1) UpdateChannelNotifyProps(channelId, userId string, props map[string]string) (bool, *Response) {
...
func (c *Client1) AddChannelMember(channelId, userId string) (*ChannelMember, *Response) {
...
func (c *Client1) AddChannelMemberWithRootId(channelId, userId, postRootId string) (*ChannelMember, *Response) {
...
func (c *Client1) RemoveUserFromChannel(channelId, userId string) (bool, *Response) {
...
func (c *Client1) AutocompleteChannelsForTeam(teamId, name string) (*ChannelList, *Response) {
...
func (c *Client1) AutocompleteChannelsForTeamForSearch(teamId, name string) (*ChannelList, *Response) {
	query := fmt.Sprintf("?name=%v", name)
...
func (c *Client1) CreatePost(post *Post) (*Post, *Response) {
...
func (c *Client1) CreatePostEphemeral(post *PostEphemeral) (*Post, *Response) {
...
func (c *Client1) UpdatePost(postId string, post *Post) (*Post, *Response) {
...
func (c *Client1) PatchPost(postId string, patch *PostPatch) (*Post, *Response) {
...
func (c *Client1) SetPostUnread(userId string, postId string) *Response {
...
func (c *Client1) PinPost(postId string) (bool, *Response) {
...
func (c *Client1) UnpinPost(postId string) (bool, *Response) {
...
func (c *Client1) GetPost(postId string, etag string) (*Post, *Response) {
...
func (c *Client1) DeletePost(postId string) (bool, *Response) {
...
func (c *Client1) GetPostThread(postId string, etag string) (*PostList, *Response) {
...
func (c *Client1) GetPostsForChannel(channelId string, page, perPage int, etag string) (*PostList, *Response) {
	query := fmt.Sprintf("?page=%v&per_page=%v", page, perPage)
...
func (c *Client1) GetFlaggedPostsForUser(userId string, page int, perPage int) (*PostList, *Response) {
	query := fmt.Sprintf("?page=%v&per_page=%v", page, perPage)
...
func (c *Client1) GetFlaggedPostsForUserInTeam(userId string, teamId string, page int, perPage int) (*PostList, *Response) {
	if !IsValidId(teamId) {
...
func (c *Client1) GetFlaggedPostsForUserInChannel(userId string, channelId string, page int, perPage int) (*PostList, *Response) {
...
func (c *Client1) GetPostsSince(channelId string, time int64) (*PostList, *Response) {
...
func (c *Client1) GetPostsAfter(channelId, postId string, page, perPage int, etag string) (*PostList, *Response) {
...
func (c *Client1) GetPostsBefore(channelId, postId string, page, perPage int, etag string) (*PostList, *Response) {
...
func (c *Client1) GetPostsAroundLastUnread(userId, channelId string, limitBefore, limitAfter int) (*PostList, *Response) {
...
func (c *Client1) SearchPosts(teamId string, terms string, isOrSearch bool) (*PostList, *Response) {
...
func (c *Client1) SearchPostsWithParams(teamId string, params *SearchParameter) (*PostList, *Response) {
...
func (c *Client1) SearchPostsWithMatches(teamId string, terms string, isOrSearch bool) (*PostSearchResults, *Response) {
...
func (c *Client1) DoPostAction(postId, actionId string) (bool, *Response) {
...
func (c *Client1) DoPostActionWithCookie(postId, actionId, selected, cookieStr string) (bool, *Response) {
	var body []byte
...
// slash commands.
func (c *Client1) OpenInteractiveDialog(request OpenDialogRequest) (bool, *Response) {
...
func (c *Client1) SubmitInteractiveDialog(request SubmitDialogRequest) (*SubmitDialogResponse, *Response) {
	b, _ := json.Marshal(request)
...
// This method is functionally equivalent to Client1.UploadFileAsRequestBody.
func (c *Client1) UploadFile(data []byte, channelId string, filename string) (*FileUploadResponse, *Response) {
	body := &bytes.Buffer{}
	writer := multipart.NewWriter(body)
...
// to a post. This method is functionally equivalent to Client1.UploadFile.
func (c *Client1) UploadFileAsRequestBody(data []byte, channelId string, filename string) (*FileUploadResponse, *Response) {
...
func (c *Client1) GetFile(fileId string) ([]byte, *Response) {
...
func (c *Client1) DownloadFile(fileId string, download bool) ([]byte, *Response) {
...
func (c *Client1) GetFileThumbnail(fileId string) ([]byte, *Response) {
...
func (c *Client1) DownloadFileThumbnail(fileId string, download bool) ([]byte, *Response) {
...
func (c *Client1) GetFileLink(fileId string) (string, *Response) {
...
func (c *Client1) GetFilePreview(fileId string) ([]byte, *Response) {
...
func (c *Client1) DownloadFilePreview(fileId string, download bool) ([]byte, *Response) {
...
func (c *Client1) GetFileInfo(fileId string) (*FileInfo, *Response) {
...
func (c *Client1) GetFileInfosForPost(postId string, etag string) ([]*FileInfo, *Response) {
...
func (c *Client1) GetPing() (string, *Response) {
...
func (c *Client1) GetPingWithServerStatus() (string, *Response) {
...
func (c *Client1) GetPingWithFullServerStatus() (map[string]string, *Response) {
	r, err := c.DoApiGet(c.GetSystemRoute()+"/ping?get_server_status="+c.boolString(true), "")
	if r != nil && r.StatusCode == 500 {
		defer r.Body.Close()
...
func (c *Client1) TestEmail(config *Config) (bool, *Response) {
...
func (c *Client1) TestSiteURL(siteURL string) (bool, *Response) {
...
func (c *Client1) TestS3Connection(config *Config) (bool, *Response) {
...
func (c *Client1) ReloadConfig() (bool, *Response) {
...
func (c *Client1) GetOldClientConfig(etag string) (map[string]string, *Response) {
...
func (c *Client1) GetEnvironmentConfig() (map[string]interface{}, *Response) {
...
// client, formatted in the old format.
func (c *Client1) GetOldClientLicense(etag string) (map[string]string, *Response) {
...
func (c *Client1) DatabaseRecycle() (bool, *Response) {
...
func (c *Client1) InvalidateCaches() (bool, *Response) {
...
func (c *Client1) UpdateConfig(config *Config) (*Config, *Response) {
...
func (c *Client1) MigrateConfig(from, to string) (bool, *Response) {
...
func (c *Client1) UploadLicenseFile(data []byte) (bool, *Response) {
	body := &bytes.Buffer{}
	writer := multipart.NewWriter(body)
...
func (c *Client1) RemoveLicenseFile() (bool, *Response) {
...
// to a specific team.
func (c *Client1) GetAnalyticsOld(name, teamId string) (AnalyticsRows, *Response) {
...
func (c *Client1) CreateIncomingWebhook(hook *IncomingWebhook) (*IncomingWebhook, *Response) {
...
func (c *Client1) UpdateIncomingWebhook(hook *IncomingWebhook) (*IncomingWebhook, *Response) {
...
func (c *Client1) GetIncomingWebhooks(page int, perPage int, etag string) ([]*IncomingWebhook, *Response) {
	query := fmt.Sprintf("?page=%v&per_page=%v", page, perPage)
...
func (c *Client1) GetIncomingWebhooksForTeam(teamId string, page int, perPage int, etag string) ([]*IncomingWebhook, *Response) {
...
func (c *Client1) GetIncomingWebhook(hookID string, etag string) (*IncomingWebhook, *Response) {
...
func (c *Client1) DeleteIncomingWebhook(hookID string) (bool, *Response) {
...
func (c *Client1) CreateOutgoingWebhook(hook *OutgoingWebhook) (*OutgoingWebhook, *Response) {
...
func (c *Client1) UpdateOutgoingWebhook(hook *OutgoingWebhook) (*OutgoingWebhook, *Response) {
...
func (c *Client1) GetOutgoingWebhooks(page int, perPage int, etag string) ([]*OutgoingWebhook, *Response) {
	query := fmt.Sprintf("?page=%v&per_page=%v", page, perPage)
...
func (c *Client1) GetOutgoingWebhook(hookId string) (*OutgoingWebhook, *Response) {
...
func (c *Client1) GetOutgoingWebhooksForChannel(channelId string, page int, perPage int, etag string) ([]*OutgoingWebhook, *Response) {
...
func (c *Client1) GetOutgoingWebhooksForTeam(teamId string, page int, perPage int, etag string) ([]*OutgoingWebhook, *Response) {
	query := fmt.Sprintf("?page=%v&per_page=%v&team_id=%v", page, perPage, teamId)
	r, err := c.DoApiGet(c.GetOutgoingWebhooksRoute()+query, etag)
	if err != nil {
		return nil, BuildErrorResponse(r, err)
...
func (c *Client1) RegenOutgoingHookToken(hookId string) (*OutgoingWebhook, *Response) {
...
func (c *Client1) DeleteOutgoingWebhook(hookId string) (bool, *Response) {
...
func (c *Client1) GetPreferences(userId string) (Preferences, *Response) {
...
func (c *Client1) UpdatePreferences(userId string, preferences *Preferences) (bool, *Response) {
...
func (c *Client1) DeletePreferences(userId string, preferences *Preferences) (bool, *Response) {
...
func (c *Client1) GetPreferencesByCategory(userId string, category string) (Preferences, *Response) {
...
func (c *Client1) GetPreferenceByCategoryAndName(userId string, category string, preferenceName string) (*Preference, *Response) {
...
func (c *Client1) GetSamlMetadata() (string, *Response) {
...
func (c *Client1) UploadSamlIdpCertificate(data []byte, filename string) (bool, *Response) {
...
// The filename parameter is deprecated and ignored: the server will pick a hard-coded filename when writing to disk.
func (c *Client1) UploadSamlPublicCertificate(data []byte, filename string) (bool, *Response) {
	body, writer, err := fileToMultipart(data, filename)
	if err != nil {
...
// The filename parameter is deprecated and ignored: the server will pick a hard-coded filename when writing to disk.
func (c *Client1) UploadSamlPrivateCertificate(data []byte, filename string) (bool, *Response) {
	body, writer, err := fileToMultipart(data, filename)
	if err != nil {
...
func (c *Client1) DeleteSamlIdpCertificate() (bool, *Response) {
...
func (c *Client1) DeleteSamlPublicCertificate() (bool, *Response) {
...
func (c *Client1) DeleteSamlPrivateCertificate() (bool, *Response) {
...
func (c *Client1) GetSamlCertificateStatus() (*SamlCertificateStatus, *Response) {
...
func (c *Client1) GetSamlMetadataFromIdp(samlMetadataURL string) (*SamlMetadataResponse, *Response) {
	requestBody := make(map[string]string)
...
func (c *Client1) CreateComplianceReport(report *Compliance) (*Compliance, *Response) {
...
func (c *Client1) GetComplianceReports(page, perPage int) (Compliances, *Response) {
	query := fmt.Sprintf("?page=%v&per_page=%v", page, perPage)
...
func (c *Client1) GetComplianceReport(reportId string) (*Compliance, *Response) {
...
func (c *Client1) DownloadComplianceReport(reportId string) ([]byte, *Response) {
...
func (c *Client1) GetClusterStatus() ([]*ClusterInfo, *Response) {
...
func (c *Client1) SyncLdap() (bool, *Response) {
...
// correctly.
func (c *Client1) TestLdap() (bool, *Response) {
...
func (c *Client1) GetLdapGroups() ([]*Group, *Response) {
	...
	if err := json.NewDecoder(r.Body).Decode(&responseData); err != nil {
		appErr := NewAppError("Api1.GetLdapGroups", "api.marshal_error", nil, err.Error(), http.StatusInternalServerError)
		return nil, BuildErrorResponse(r, appErr)
	}
...
func (c *Client1) LinkLdapGroup(dn string) (*Group, *Response) {
...
func (c *Client1) UnlinkLdapGroup(dn string) (*Group, *Response) {
	path := fmt.Sprintf("%s/groups/%s/link", c.GetLdapRoute(), dn)
...
func (c *Client1) MigrateIdLdap(toAttribute string) (bool, *Response) {
...
func (c *Client1) GetGroupsByChannel(channelId string, opts GroupSearchOpts) ([]*GroupWithSchemeAdmin, int, *Response) {
	...
	if err := json.NewDecoder(r.Body).Decode(&responseData); err != nil {
		appErr := NewAppError("Api1.GetGroupsByChannel", "api.marshal_error", nil, err.Error(), http.StatusInternalServerError)
		return nil, 0, BuildErrorResponse(r, appErr)
	}
...
func (c *Client1) GetGroupsByTeam(teamId string, opts GroupSearchOpts) ([]*GroupWithSchemeAdmin, int, *Response) {
	...
	if err := json.NewDecoder(r.Body).Decode(&responseData); err != nil {
		appErr := NewAppError("Api1.GetGroupsByTeam", "api.marshal_error", nil, err.Error(), http.StatusInternalServerError)
		return nil, 0, BuildErrorResponse(r, appErr)
	}
...
func (c *Client1) GetGroupsAssociatedToChannelsByTeam(teamId string, opts GroupSearchOpts) (map[string][]*GroupWithSchemeAdmin, *Response) {
	...
	if err := json.NewDecoder(r.Body).Decode(&responseData); err != nil {
		appErr := NewAppError("Api1.GetGroupsAssociatedToChannelsByTeam", "api.marshal_error", nil, err.Error(), http.StatusInternalServerError)
		return nil, BuildErrorResponse(r, appErr)
	}
...
func (c *Client1) GetGroups(opts GroupSearchOpts) ([]*Group, *Response) {
	path := fmt.Sprintf(
...
func (c *Client1) GetGroupsByUserId(userId string) ([]*Group, *Response) {
	path := fmt.Sprintf(
		"%s/%v/groups",
		c.GetUsersRoute(),
		userId,
...
func (c *Client1) MigrateAuthToLdap(fromAuthService string, matchField string, force bool) (bool, *Response) {
...
func (c *Client1) MigrateAuthToSaml(fromAuthService string, usersMap map[string]string, auto bool) (bool, *Response) {
...
func (c *Client1) UploadLdapPublicCertificate(data []byte) (bool, *Response) {
...
func (c *Client1) UploadLdapPrivateCertificate(data []byte) (bool, *Response) {
...
func (c *Client1) DeleteLdapPublicCertificate() (bool, *Response) {
...
func (c *Client1) DeleteLdapPrivateCertificate() (bool, *Response) {
...
func (c *Client1) GetAudits(page int, perPage int, etag string) (Audits, *Response) {
	query := fmt.Sprintf("?page=%v&per_page=%v", page, perPage)
...
func (c *Client1) GetBrandImage() ([]byte, *Response) {
...
func (c *Client1) DeleteBrandImage() *Response {
...
func (c *Client1) UploadBrandImage(data []byte) (bool, *Response) {
	body := &bytes.Buffer{}
	writer := multipart.NewWriter(body)
...
func (c *Client1) GetLogs(page, perPage int) ([]string, *Response) {
...
func (c *Client1) PostLog(message map[string]string) (map[string]string, *Response) {
...
func (c *Client1) CreateOAuthApp(app *OAuthApp) (*OAuthApp, *Response) {
...
func (c *Client1) UpdateOAuthApp(app *OAuthApp) (*OAuthApp, *Response) {
...
func (c *Client1) GetOAuthApps(page, perPage int) ([]*OAuthApp, *Response) {
	query := fmt.Sprintf("?page=%v&per_page=%v", page, perPage)
...
func (c *Client1) GetOAuthApp(appId string) (*OAuthApp, *Response) {
...
func (c *Client1) GetOAuthAppInfo(appId string) (*OAuthApp, *Response) {
...
func (c *Client1) DeleteOAuthApp(appId string) (bool, *Response) {
...
func (c *Client1) RegenerateOAuthAppSecret(appId string) (*OAuthApp, *Response) {
...
func (c *Client1) GetAuthorizedOAuthAppsForUser(userId string, page, perPage int) ([]*OAuthApp, *Response) {
	query := fmt.Sprintf("?page=%v&per_page=%v", page, perPage)
...
func (c *Client1) AuthorizeOAuthApp(authRequest *AuthorizeRequest) (string, *Response) {
...
func (c *Client1) DeauthorizeOAuthApp(appId string) (bool, *Response) {
...
func (c *Client1) GetOAuthAccessToken(data url.Values) (*AccessResponse, *Response) {
...
// correctly.
func (c *Client1) TestElasticsearch() (bool, *Response) {
...
func (c *Client1) PurgeElasticsearchIndexes() (bool, *Response) {
...
func (c *Client1) PurgeBleveIndexes() (bool, *Response) {
...
func (c *Client1) GetDataRetentionPolicy() (*DataRetentionPolicy, *Response) {
...
func (c *Client1) CreateCommand(cmd *Command) (*Command, *Response) {
...
func (c *Client1) UpdateCommand(cmd *Command) (*Command, *Response) {
...
func (c *Client1) MoveCommand(teamId string, commandId string) (bool, *Response) {
...
func (c *Client1) DeleteCommand(commandId string) (bool, *Response) {
...
func (c *Client1) ListCommands(teamId string, customOnly bool) ([]*Command, *Response) {
...
func (c *Client1) ListCommandAutocompleteSuggestions(userInput, teamId string) ([]AutocompleteSuggestion, *Response) {
...
func (c *Client1) GetCommandById(cmdId string) (*Command, *Response) {
...
func (c *Client1) ExecuteCommand(channelId, command string) (*CommandResponse, *Response) {
...
func (c *Client1) ExecuteCommandWithTeam(channelId, teamId, command string) (*CommandResponse, *Response) {
	commandArgs := &CommandArgs{
		ChannelId: channelId,
		TeamId:    teamId,
		Command:   command,
...
func (c *Client1) ListAutocompleteCommands(teamId string) ([]*Command, *Response) {
...
func (c *Client1) RegenCommandToken(commandId string) (string, *Response) {
...
func (c *Client1) GetUserStatus(userId, etag string) (*Status, *Response) {
...
func (c *Client1) GetUsersStatusesByIds(userIds []string) ([]*Status, *Response) {
...
func (c *Client1) UpdateUserStatus(userId string, userStatus *Status) (*Status, *Response) {
...
func (c *Client1) CreateEmoji(emoji *Emoji, image []byte, filename string) (*Emoji, *Response) {
	body := &bytes.Buffer{}
	writer := multipart.NewWriter(body)
...
func (c *Client1) GetEmojiList(page, perPage int) ([]*Emoji, *Response) {
	query := fmt.Sprintf("?page=%v&per_page=%v", page, perPage)
...
func (c *Client1) GetSortedEmojiList(page, perPage int, sort string) ([]*Emoji, *Response) {
...
func (c *Client1) DeleteEmoji(emojiId string) (bool, *Response) {
...
func (c *Client1) GetEmoji(emojiId string) (*Emoji, *Response) {
...
func (c *Client1) GetEmojiByName(name string) (*Emoji, *Response) {
...
func (c *Client1) GetEmojiImage(emojiId string) ([]byte, *Response) {
...
func (c *Client1) SearchEmoji(search *EmojiSearch) ([]*Emoji, *Response) {
...
func (c *Client1) AutocompleteEmoji(name string, etag string) ([]*Emoji, *Response) {
	query := fmt.Sprintf("?name=%v", name)
...
func (c *Client1) SaveReaction(reaction *Reaction) (*Reaction, *Response) {
...
func (c *Client1) GetReactions(postId string) ([]*Reaction, *Response) {
...
func (c *Client1) DeleteReaction(reaction *Reaction) (bool, *Response) {
...
func (c *Client1) GetBulkReactions(postIds []string) (map[string][]*Reaction, *Response) {
...
func (c *Client1) GetSupportedTimezone() ([]string, *Response) {
...
func (c *Client1) OpenGraph(url string) (map[string]string, *Response) {
	requestBody := make(map[string]string)
	requestBody["url"] = url
...
func (c *Client1) GetJob(id string) (*Job, *Response) {
...
func (c *Client1) GetJobs(page int, perPage int) ([]*Job, *Response) {
...
func (c *Client1) GetJobsByType(jobType string, page int, perPage int) ([]*Job, *Response) {
...
func (c *Client1) CreateJob(job *Job) (*Job, *Response) {
...
func (c *Client1) CancelJob(jobId string) (bool, *Response) {
...
func (c *Client1) DownloadJob(jobId string) ([]byte, *Response) {
...
func (c *Client1) GetRole(id string) (*Role, *Response) {
...
func (c *Client1) GetRoleByName(name string) (*Role, *Response) {
...
func (c *Client1) GetRolesByNames(roleNames []string) ([]*Role, *Response) {
...
func (c *Client1) PatchRole(roleId string, patch *RolePatch) (*Role, *Response) {
...
func (c *Client1) CreateScheme(scheme *Scheme) (*Scheme, *Response) {
...
func (c *Client1) GetScheme(id string) (*Scheme, *Response) {
...
func (c *Client1) GetSchemes(scope string, page int, perPage int) ([]*Scheme, *Response) {
...
func (c *Client1) DeleteScheme(id string) (bool, *Response) {
...
func (c *Client1) PatchScheme(id string, patch *SchemePatch) (*Scheme, *Response) {
...
func (c *Client1) GetTeamsForScheme(schemeId string, page int, perPage int) ([]*Team, *Response) {
...
func (c *Client1) GetChannelsForScheme(schemeId string, page int, perPage int) (ChannelList, *Response) {
...
func (c *Client1) UploadPlugin(file io.Reader) (*Manifest, *Response) {
	return c.uploadPlugin(file, false)
}

func (c *Client1) UploadPluginForced(file io.Reader) (*Manifest, *Response) {
	return c.uploadPlugin(file, true)
}

func (c *Client1) uploadPlugin(file io.Reader, force bool) (*Manifest, *Response) {
...
func (c *Client1) InstallPluginFromUrl(downloadUrl string, force bool) (*Manifest, *Response) {
...
// WARNING: PLUGINS ARE STILL EXPERIMENTAL. THIS FUNCTION IS SUBJECT TO CHANGE.
func (c *Client1) InstallMarketplacePlugin(request *InstallMarketplacePluginRequest) (*Manifest, *Response) {
...
// WARNING: PLUGINS ARE STILL EXPERIMENTAL. THIS FUNCTION IS SUBJECT TO CHANGE.
func (c *Client1) GetPlugins() (*PluginsResponse, *Response) {
...
// WARNING: PLUGINS ARE STILL EXPERIMENTAL. THIS FUNCTION IS SUBJECT TO CHANGE.
func (c *Client1) GetPluginStatuses() (PluginStatuses, *Response) {
...
// WARNING: PLUGINS ARE STILL EXPERIMENTAL. THIS FUNCTION IS SUBJECT TO CHANGE.
func (c *Client1) RemovePlugin(id string) (bool, *Response) {
...
// WARNING: PLUGINS ARE STILL EXPERIMENTAL. THIS FUNCTION IS SUBJECT TO CHANGE.
func (c *Client1) GetWebappPlugins() ([]*Manifest, *Response) {
...
// WARNING: PLUGINS ARE STILL EXPERIMENTAL. THIS FUNCTION IS SUBJECT TO CHANGE.
func (c *Client1) EnablePlugin(id string) (bool, *Response) {
...
// WARNING: PLUGINS ARE STILL EXPERIMENTAL. THIS FUNCTION IS SUBJECT TO CHANGE.
func (c *Client1) DisablePlugin(id string) (bool, *Response) {
...
// WARNING: PLUGINS ARE STILL EXPERIMENTAL. THIS FUNCTION IS SUBJECT TO CHANGE.
func (c *Client1) GetMarketplacePlugins(filter *MarketplacePluginFilter) ([]*MarketplacePlugin, *Response) {
...
func (c *Client1) UpdateChannelScheme(channelId, schemeId string) (bool, *Response) {
...
func (c *Client1) UpdateTeamScheme(teamId, schemeId string) (bool, *Response) {
	sip := &SchemeIDPatch{SchemeID: &schemeId}
...
func (c *Client1) GetRedirectLocation(urlParam, etag string) (string, *Response) {
...
func (c *Client1) SetServerBusy(secs int) (bool, *Response) {
...
func (c *Client1) ClearServerBusy() (bool, *Response) {
...
func (c *Client1) GetServerBusy() (*ServerBusyState, *Response) {
...
func (c *Client1) GetServerBusyExpires() (*time.Time, *Response) {
	r, err := c.DoApiGet(c.GetServerBusyRoute(), "")
	if err != nil {
		return nil, BuildErrorResponse(r, err)
	}
...
func (c *Client1) RegisterTermsOfServiceAction(userId, termsOfServiceId string, accepted bool) (*bool, *Response) {
...
func (c *Client1) GetTermsOfService(etag string) (*TermsOfService, *Response) {
...
func (c *Client1) GetUserTermsOfService(userId, etag string) (*UserTermsOfService, *Response) {
	url := c.GetUserTermsOfServiceRoute(userId)
	r, err := c.DoApiGet(url, etag)
	if err != nil {
		return nil, BuildErrorResponse(r, err)
...
func (c *Client1) CreateTermsOfService(text, userId string) (*TermsOfService, *Response) {
	url := c.GetTermsOfServiceRoute()
...
func (c *Client1) GetGroup(groupID, etag string) (*Group, *Response) {
...
func (c *Client1) PatchGroup(groupID string, patch *GroupPatch) (*Group, *Response) {
...
func (c *Client1) LinkGroupSyncable(groupID, syncableID string, syncableType GroupSyncableType, patch *GroupSyncablePatch) (*GroupSyncable, *Response) {
	payload, _ := json.Marshal(patch)
...
func (c *Client1) UnlinkGroupSyncable(groupID, syncableID string, syncableType GroupSyncableType) *Response {
	url := fmt.Sprintf("%s/link", c.GetGroupSyncableRoute(groupID, syncableID, syncableType))
...
func (c *Client1) GetGroupSyncable(groupID, syncableID string, syncableType GroupSyncableType, etag string) (*GroupSyncable, *Response) {
...
func (c *Client1) GetGroupSyncables(groupID string, syncableType GroupSyncableType, etag string) ([]*GroupSyncable, *Response) {
...
func (c *Client1) PatchGroupSyncable(groupID, syncableID string, syncableType GroupSyncableType, patch *GroupSyncablePatch) (*GroupSyncable, *Response) {
	payload, _ := json.Marshal(patch)
...
func (c *Client1) TeamMembersMinusGroupMembers(teamID string, groupIDs []string, page, perPage int, etag string) ([]*UserWithGroups, int64, *Response) {
...
func (c *Client1) ChannelMembersMinusGroupMembers(channelID string, groupIDs []string, page, perPage int, etag string) ([]*UserWithGroups, int64, *Response) {
	groupIDStr := strings.Join(groupIDs, ",")
	query := fmt.Sprintf("?group_ids=%s&page=%d&per_page=%d", groupIDStr, page, perPage)
...
func (c *Client1) PatchConfig(config *Config) (*Config, *Response) {
...
func (c *Client1) GetChannelModerations(channelID string, etag string) ([]*ChannelModeration, *Response) {
...
func (c *Client1) PatchChannelModerations(channelID string, patch []*ChannelModerationPatch) ([]*ChannelModeration, *Response) {
	payload, _ := json.Marshal(patch)
...
func (c *Client1) GetKnownUsers() ([]string, *Response) {
...
func (c *Client1) PublishUserTyping(userID string, typingRequest TypingRequest) (bool, *Response) {
...
func (c *Client1) GetChannelMemberCountsByGroup(channelID string, includeTimezones bool, etag string) ([]*ChannelMemberCountByGroup, *Response) {
...
func (c *Client1) RequestTrialLicense(users int) (bool, *Response) {
...
func (c *Client1) GetGroupStats(groupID string) (*GroupStats, *Response) {
...
func (c *Client1) GetSidebarCategoriesForTeamForUser(userID, teamID, etag string) (*OrderedSidebarCategories, *Response) {
	...
	if err != nil {
		return nil, BuildErrorResponse(r, NewAppError("Client1.GetSidebarCategoriesForTeamForUser", "model.utils.decode_json.app_error", nil, err.Error(), r.StatusCode))
	}
	return cat, BuildResponse(r)
}

func (c *Client1) CreateSidebarCategoryForTeamForUser(userID, teamID string, category *SidebarCategoryWithChannels) (*SidebarCategoryWithChannels, *Response) {
	...
	if err != nil {
		return nil, BuildErrorResponse(r, NewAppError("Client1.CreateSidebarCategoryForTeamForUser", "model.utils.decode_json.app_error", nil, err.Error(), r.StatusCode))
	}
	return cat, BuildResponse(r)
}

func (c *Client1) UpdateSidebarCategoriesForTeamForUser(userID, teamID string, categories []*SidebarCategoryWithChannels) ([]*SidebarCategoryWithChannels, *Response) {
	...
	if err != nil {
		return nil, BuildErrorResponse(r, NewAppError("Client1.UpdateSidebarCategoriesForTeamForUser", "model.utils.decode_json.app_error", nil, err.Error(), r.StatusCode))
	}

	return categories, BuildResponse(r)
}

func (c *Client1) GetSidebarCategoryOrderForTeamForUser(userID, teamID, etag string) ([]string, *Response) {
...
func (c *Client1) UpdateSidebarCategoryOrderForTeamForUser(userID, teamID string, order []string) ([]string, *Response) {
...
func (c *Client1) GetSidebarCategoryForTeamForUser(userID, teamID, categoryID, etag string) (*SidebarCategoryWithChannels, *Response) {
...
func (c *Client1) UpdateSidebarCategoryForTeamForUser(userID, teamID, categoryID string, category *SidebarCategoryWithChannels) (*SidebarCategoryWithChannels, *Response) {
	payload, _ := json.Marshal(category)
	route := c.GetUserCategoryRoute(userID, teamID) + "/" + categoryID
	r, appErr := c.doApiPutBytes(route, payload)
	if appErr != nil {
...
func (c *Client1) CheckIntegrity() ([]IntegrityCheckResult, *Response) {
	...
	if err := json.NewDecoder(r.Body).Decode(&results); err != nil {
		appErr := NewAppError("Api1.CheckIntegrity", "api.marshal_error", nil, err.Error(), http.StatusInternalServerError)
		return nil, BuildErrorResponse(r, appErr)
	}
	return results, BuildResponse(r)
}

func (c *Client1) GetNotices(lastViewed int64, teamId string, client NoticeClientType, clientVersion, locale, etag string) (NoticeMessages, *Response) {
...
func (c *Client1) MarkNoticesViewed(ids []string) *Response {
...
func (c *Client1) CreateUpload(us *UploadSession) (*UploadSession, *Response) {
...
func (c *Client1) GetUpload(uploadId string) (*UploadSession, *Response) {
...
// userId.
func (c *Client1) GetUploadsForUser(userId string) ([]*UploadSession, *Response) {
...
// a FileInfo object.
func (c *Client1) UploadData(uploadId string, data io.Reader) (*FileInfo, *Response) {
...
func (c *Client1) UpdatePassword(userId, currentPassword, newPassword string) *Response {
	requestBody := map[string]string{"current_password": currentPassword, "new_password": newPassword}
	r, err := c.DoApiPut(c.GetUserRoute(userId)+"/password", MapToJson(requestBody))
	if err != nil {
		return BuildErrorResponse(r, err)
...
func (c *Client1) GetCloudProducts() ([]*Product, *Response) {
...
func (c *Client1) CreateCustomerPayment() (*StripeSetupIntent, *Response) {
...
func (c *Client1) ConfirmCustomerPayment(confirmRequest *ConfirmPaymentMethodRequest) *Response {
...
func (c *Client1) GetCloudCustomer() (*CloudCustomer, *Response) {
...
func (c *Client1) GetSubscription() (*Subscription, *Response) {
...
func (c *Client1) GetInvoicesForSubscription() ([]*Invoice, *Response) {
...
func (c *Client1) UpdateCloudCustomer(customerInfo *CloudCustomerInfo) (*CloudCustomer, *Response) {
...
func (c *Client1) UpdateCloudCustomerAddress(address *Address) (*CloudCustomer, *Response) {
...
func (c *Client1) ListImports() ([]string, *Response) {
...
func (c *Client1) GetUserThreads(userId, teamId string, options GetUserThreadsOpts) (*Threads, *Response) {
	v := url.Values{}
	if options.Since != 0 {
		v.Set("since", fmt.Sprintf("%d", options.Since))
	}
...
func (c *Client1) UpdateThreadsReadForUser(userId, teamId string) *Response {
...
func (c *Client1) UpdateThreadReadForUser(userId, teamId, threadId string, timestamp int64) *Response {
...
func (c *Client1) UpdateThreadFollowForUser(userId, teamId, threadId string, state bool) *Response {
	var appErr *AppError
	var r *http.Response
	if state {
...
func (c *Client1) CreateTrackPointForRecordRoute(trackRecordId string) string {
